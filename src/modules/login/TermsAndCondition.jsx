...
const TermsAndCondition = () => (
  <div className="terms-of-service">
    ...
    <section>
      <h2>Overview</h2>
      <p>
        This website is operated by <strong>[Elabpro]</strong>.
        Throughout the site, the terms “we”, “us” and “our” refer to{" "}
        <strong>[Elabpro]</strong>.{" "}
        <strong>[Elabpro]</strong> offers this website, including all
    ...
    <section>
      ...
      <p>
        ...
        questions regarding third-party products should be directed to the third
        party.
      </p>
    </section>
    ...
    <section>
      ...
      <p>
        ...
        we determine in our sole discretion is unlawful, offensive, threatening,
      ...
      <p>
        ...
        not contain libelous or otherwise unlawful, abusive, or obscene
    ...
    <section>
      ...
      <p>
        In addition to other prohibitions set forth in the Terms of Service, you
        are prohibited from using the site or its content for unlawful purposes,
        to solicit others to participate in unlawful acts, and to harass, abuse,
        insult, harm, defame, slander, intimidate, or discriminate, among other
        prohibited uses.
      </p>
    </section>
    ...
    <section>
      ...
      <p>
        ...
        timely, secure, or error-free. You expressly agree that your use of, or
        inability to use, the service is at your sole risk. The service and all
        products delivered to you are provided 'as is' and 'as available'
    ...
    <section>
      ...
      <p>
        You agree to indemnify, defend, and hold harmless [ElabPro] and its
        affiliates, employees, and agents from any claims due to your breach of
    ...
    <section>
      ...
      <p>
        If any provision of these Terms of Service is deemed unlawful, void, or
        unenforceable, the enforceable part shall remain effective to the
    ...
    <section>
      ...
      <p>
        These Terms of Service are effective unless terminated by either you or
        us. If you fail to comply with any terms, we may terminate this
    ...
    <section>
      ...
      <p>
        ...
        us, superseding any prior agreements.
      </p>
    </section>
    ...
    <section>
      ...
      <p>
        ...
        with the laws of India, with jurisdiction in Jaipur, Rajasthan.
      </p>
    </section>
    ...
    <section>
      ...
      <p>
        We reserve the right to update or change any part of these Terms of
        Service by posting updates on our website. Continued use of our website
    ...
    <section>
      ...
      <p>
        Questions about the Terms of Service should be sent to us at [ElabPro].
      </p>
    </section>
    <section>
      <h2>-------------------------------------</h2>
